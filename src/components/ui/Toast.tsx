                ...
                <AnimatePresence>
                    {toasts.map((t) => (
                        <motion.div
                            ...
                            className={cn(
                                "pointer-events-auto flex items-center gap-3 px-4 py-3 rounded-2xl border shadow-xl min-w-[300px] max-w-md",
                                t.type === "success" && "bg-success text-white border-success",
                                t.type === "error" && "bg-error text-white border-error",
                                t.type === "warning" && "bg-warning text-white border-warning",
                        ...
                        >
                            ...
                            <p className="flex-grow text-sm font-medium">{t.message}</p>
                            <button
